...
?>
    ...
    <meta name="keywords"
        content="Website, blog, E-learning, Education,learn, learning, class, classes, teach, education, how to, online learning, collaborative learning, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons,Learn to code">
    <meta name="description"
        content="LoopSync is an online learning and teaching marketplace. Anyone can take an online class, watch video lessons, create projects, and even teach a class themselves.">
